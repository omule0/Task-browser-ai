      ...
      {workspaces.length >= 3 && (
        <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
          <div className="flex items-start">
            ...
            <div className="ml-3">
              <h3 className="text-sm font-medium text-purple-800">Workspace Limit Reached</h3>
              <div className="mt-1 text-sm text-purple-700">
                <p>You have reached the maximum limit of 3 workspaces. To create a new workspace, you'll need to delete an existing one first.</p>
              </div>
            </div>
          </div>
        </div>
