export function isTokenLimitExceeded(tokenUsage, TOKEN_LIMIT = 200000) {
  return tokenUsage.totalTokensUsed >= TOKEN_LIMIT;
}

export function isApproachingTokenLimit(tokenUsage, TOKEN_LIMIT = 200000) {
  const ESTIMATED_TOKENS_PER_GENERATION = 25000;
